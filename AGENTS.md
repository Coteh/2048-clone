...
Keep it that way — do not let an `/init`-style command copy this file's contents into it, since
duplicated instructions drift apart and nothing says which copy is current.
